...
#Costruisce la tabella LOGO che serve anche per le foto di speaker e presenter
CREATE TABLE LOGO (
...
CREATE TABLE CONFERENZA (
    ...
    AnnoEdizione YEAR NOT NULL UNIQUE,
...
#Costruisce la tabella NOMEPRESENTAZIONE
CREATE TABLE NOMEPRESENTAZIONE (
	UsernameUtente VARCHAR (100),
    FOREIGN KEY (UsernameUtente) REFERENCES Utente(Username),
    Nome VARCHAR (100) PRIMARY KEY
) ENGINE=INNODB;
...
CREATE TABLE SESSIONE (
    ...
    CodiceProgrammaGiornaliero VARCHAR (10),
...
CREATE TABLE PRESENTAZIONEDIARTICOLI (
    ...
    CodiceSessione VARCHAR(10) NOT NULL,
...
CREATE TABLE PAROLACHIAVE (
    ...
    CodicePresentazioneDiArticoli VARCHAR (10),
...
CREATE TABLE VALUTAZIONE (
    ...
    Note VARCHAR (50),
    CodiceTutorial VARCHAR(10) NULL,
    CodicePresentazioneDiArticoli VARCHAR(10) NULL,
    FOREIGN KEY (UsernameUtenteAmministratore) REFERENCES AMMINISTRATORE(UsernameUtente),
    FOREIGN KEY (CodiceTutorial) REFERENCES TUTORIAL(Codice),
    FOREIGN KEY (CodicePresentazioneDiArticoli) REFERENCES PRESENTAZIONEDIARTICOLI(Codice)
) ENGINE=INNODB;
