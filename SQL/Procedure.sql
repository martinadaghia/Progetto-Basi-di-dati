...
DELIMITER |
CREATE PROCEDURE registrazioneSpeaker(IN InputUsername VARCHAR(100), IN InputNome VARCHAR(100), IN InputCv INT, IN InputFoto INT, IN InputDipartimento VARCHAR(50), OUT Esito VARCHAR(100)) 
BEGIN
...
DELIMITER |
CREATE PROCEDURE registrazionePresenter(IN InputUsername VARCHAR(100), IN InputNome VARCHAR(100), IN InputCv INT, IN InputFoto INT, IN InputDipartimento VARCHAR(50), OUT Esito VARCHAR(100)) 
BEGIN
