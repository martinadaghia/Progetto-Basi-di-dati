...
CREATE VIEW NumeroSponsorizzazioni AS
	SELECT NomeSponsor, COUNT(*) AS numeroSponsorizzazioni 
	FROM DISPOSIZIONE 
...
BEGIN
	SELECT Titolo, OraInizio, OraFine, Voto, Note
        ...
        WHERE VALUTAZIONE.CodicePresentazioneDiArticoli != NULL AND PRESENTAZIONEDIARTICOLI.Codice = CodicePresentazioneArticoli
...
BEGIN
	SELECT Titolo, OraInizio, OraFine, Voto, Note
        ...
        WHERE VALUTAZIONE.CodiceTutorial != NULL AND TUTORIAL.Codice = CodicePresentazioneTutorial
