  ...
  <img class="mb-4" src="risorse/immagini/logo.png" alt="" height="100px">
    ...
    <form name="formRegister" action="" method="post" enctype="multipart/form-data"> <!-- post per maggiore sicurezza, per passare dati sensibili alla pagina --> 
      ...
      <div class="form-floating">
        <input name="emailRegister" type="text" class="form-control" id="emailInput" placeholder="Username">
      ...
      <div class="form-floating">
        <input name="cvRegister" type="text" class="form-control" id="cvRegister" >
  ...
  if(isset($_POST["submit"])){
    ...
    && !empty($_POST["dataNascitaRegister"])  && !empty($_POST["luogoNascitaRegister"])){
      ...
      if($tipo=="amministratore"){
        ...
        $dbh->insertSpeaker($username, $nome, $cv, $ultimaFoto[0]["idLogo"], $dipartimento);
        ...
        $dbh->insertPresenter($username, $nome, $cv, $ultimaFoto[0]["idLogo"], $dipartimento);
      }
