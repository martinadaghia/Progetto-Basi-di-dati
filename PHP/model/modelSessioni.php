    ...
    <?php foreach($sessioni as $sessione): ?>
      ...
      if(count($articoli)>0){
        ...
        foreach($articoli as $articolo): 
          echo "<li>";
          echo "CODICE ARTICOLO: " ."<b>".$articolo['Codice'] ."</b>". " - ORA INIZIO: " ."<b>". $articolo['OraInizio']  ."</b>"
          . " - ORA FINE: " ."<b>". $articolo['OraFine']."</b>" . " - TITOLO: " ."<b>". $articolo['Titolo'] ."</b>"
          . " - PRESENTER: " ."<b>". $articolo['UsernameUtentePresenter'] ."</b>" ;
          echo("<a href='.\\risorse\\file\\' download='".$articolo["NomeFile"]."' >");
          echo("<button>Scarica Presentazione</buttton>");
          echo("</a>");
          echo "</li>";
        endforeach;
        ?>
      ...
      if(count($tutorial)>0){
        ...
        foreach($tutorial as $tut): 
          echo "<li>";
          echo "CODICE TUTORIAL: "."<b>" .$tut['Codice'] ."</b>". " - ORA INIZIO: "."<b>" . $tut['OraInizio']  ."</b>"
