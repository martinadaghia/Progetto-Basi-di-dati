...
<div class="position-relative overflow-hidden p-1 p-md-1 m-md-1 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-1">
    <h1 class="display-4 fw-normal">UTENTE</h1>
  </div>
  <!-- STAMPARE ELENCO CONFERENZE CON UN BOTTONE DI FIANCO PER REGISTRARSI -->
  <!-- INSERISCI BOTTONE "PROGRAMMA GIORNALIERO" DI FIANCO AD OGNI EVENTO -->
  <!-- PER OGNI PROGRAMMA GIORNALIERO, VISUALIZZA LE SUE SESSIONI -->
  <!-- PER OGNI SESSIONE, VISUALIZZA LE PRESENTAZIONI -->
