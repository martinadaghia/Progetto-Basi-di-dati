...
<div class="m-5" style ="text-align: left">
  ...
  <?php echo("<img src='.\\risorse\\immagini\\".$articoli[0]["NomeFile"]."' width='300' height='200'"); ?>     
...
?>
  ...
  <div class="m-5" style ="text-align: left">
    ...
    if(isset($_POST["inserisciArticoli"])){
      ...
      $dirFoto=__DIR__."\\risorse\\file";

      move_uploaded_file($_FILES["filePresentazione"]["tmp_name"], $dirFoto."\\".$_SESSION["username"]."_".$nomeFile); // spostare file dentro xamp
...
<?php
  ...
  if(isset($_POST["modificaFotoPresenter"])){
    ...
    $dirFoto=__DIR__."\\risorse\\immagini";

    move_uploaded_file($_FILES["fotoPresenter"]["tmp_name"], $dirFoto."\\".$_SESSION["username"]."_".$nomeFoto); // spostare file dentro xamp
  ...
  if(isset($_POST["modificaFotoSpeaker"])){
    ...
    move_uploaded_file($_FILES["fotoSpeaker"]["tmp_name"], $dirFoto."\\".$_SESSION["username"]."_".$nomeFoto); // spostare file dentro xamp
