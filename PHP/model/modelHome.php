...
<div class="m-5">
  ...
  <p class="col-md-8 fs-5">Classifica presenter e speaker: </p>
    ...
    <?php foreach($sponsorizzazioni as $sponsorizzazione): ?> 
      <li><?php echo "Sponsorizzazione: " .$sponsorizzazione['NomeSponsor'] . " - Numero: " . $sponsorizzazione['numeroSponsorizzazioni'] ;?> <br><?php echo("<img src='.".DIRECTORY_SEPARATOR."risorse".DIRECTORY_SEPARATOR."immagini".DIRECTORY_SEPARATOR.$sponsorizzazione["NomeFile"]."' width='300' height='200'"); ?></li> <br>
    <?php endforeach; ?>     
</div>
